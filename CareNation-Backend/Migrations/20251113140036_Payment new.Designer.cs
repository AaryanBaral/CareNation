...
namespace backend.Migrations
{
    ...
    [Migration("20251113140036_Payment new")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.KhaltiPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("KhaltiPayments", (string)null);
                });
            ...
            modelBuilder.Entity("backend.Models.User", b =>
                {
                    ...
                    b.Property<decimal>("CompanyPoints")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("HousePoints")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("RepurchasePoints")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("RightWallet")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("RoyaltyPoints")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("TravelPoints")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("backend.Models.Payment", b =>
                {
                    ...
                    b.HasOne("backend.Models.User", "PaidToUser")
                        .WithMany()
                        .HasForeignKey("PaidToUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("backend.Models.WithdrawalRequest", "WithdrawalRequest")
                        .WithOne("Payment")
                        .HasForeignKey("backend.Models.Payment", "WithdrawalRequestId")
                        .OnDelete(DeleteBehavior.Cascade);

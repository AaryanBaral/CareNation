...
public class ReportRepository : IReportRepository
{
    ...
    public async Task<List<WithdrawalRequestDto>> GetWithdrawalRequestsAsync(DateTime? from = null, DateTime? to = null, string? status = null)
    {
        ...
        var list = await query
            ...
            .Select(w => new WithdrawalRequestDto
            {
                ...
                Remarks = w.Remarks,
                PaymentId = w.Payment != null ? w.Payment.Id : null,
                PaymentStatus = w.Payment != null ? w.Payment.Status.ToString() : null,
                PaymentProofUrl = w.Payment != null ? w.Payment.ProofImageUrl : null,
                PaymentReferenceNumber = w.Payment != null ? w.Payment.ReferenceNumber : null,
                PaidAt = w.Payment != null ? w.Payment.PaidAt : null
            })
            .ToListAsync();
        ...
        string? userId = null, DateTime? from = null, DateTime? to = null)
    {
        ...
        if (!string.IsNullOrEmpty(userId))
            paymentQuery = paymentQuery.Where(p => p.PaidToUserId == userId || p.PaidByUserId == userId);
        ...
        var payments = await paymentQuery
            .Select(p => new FullTransactionDto
            {
                TransactionType = p.PaymentType == PaymentType.Order ? "Order Payment" : "Withdrawal Payment",
                TransactionId = p.Id,
                UserId = p.PaidToUserId ?? p.PaidByUserId ?? "",
                UserName = p.PaidToUser != null
                    ? ((p.PaidToUser.FirstName ?? "") + " " + (p.PaidToUser.MiddleName ?? "") + " " + (p.PaidToUser.LastName ?? "")).Trim()
                    : p.PaidByUser != null
                        ? ((p.PaidByUser.FirstName ?? "") + " " + (p.PaidByUser.MiddleName ?? "") + " " + (p.PaidByUser.LastName ?? "")).Trim()
                        : "",
                UserEmail = p.PaidToUser != null
                    ? (p.PaidToUser.Email ?? "")
                    : p.PaidByUser != null
                        ? (p.PaidByUser.Email ?? "")
                        : "",
                ...
                Remarks = string.IsNullOrWhiteSpace(p.Notes)
                    ? (string.IsNullOrWhiteSpace(p.ReferenceNumber) ? null : $"Reference: {p.ReferenceNumber}")
                    : p.Notes
            })
            .ToListAsync();
    ...
    public async Task<List<PaymentReadDto>> GetPaymentsAsync(PaymentType? type, DateTime? from = null, DateTime? to = null)
    {
    ...
    public async Task<List<PaymentReadDto>> GetPaymentsByDistributorAsync(string userId, PaymentType? type, DateTime? from = null, DateTime? to = null)
    {

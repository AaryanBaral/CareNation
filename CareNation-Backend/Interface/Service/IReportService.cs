...
public interface IReportService
{
    ...
    Task<IEnumerable<PaymentReadDto>> GetPaymentReportAsync(PaymentType? type, DateTime? from, DateTime? to);
    Task<IEnumerable<PaymentReadDto>> GetPaymentReportForDistributorAsync(string userId, PaymentType? type, DateTime? from, DateTime? to);

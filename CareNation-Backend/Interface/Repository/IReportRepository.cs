...
public interface IReportRepository
{
    ...
    Task<List<SalesByTimeDto>> GetSalesByTimeForDistributorAsync(string distributorId, DateTime? from = null, DateTime? to = null, string period = "day");
    Task<List<PaymentReadDto>> GetPaymentsAsync(PaymentType? type, DateTime? from = null, DateTime? to = null);
    Task<List<PaymentReadDto>> GetPaymentsByDistributorAsync(string userId, PaymentType? type, DateTime? from = null, DateTime? to = null);

...
namespace backend.Data
{
      public class AppDbContext : IdentityDbContext<User>
      {
            ...
            public DbSet<KhaltiPayment> KhaltiPayments { get; set; } = default!;
            ...
            protected override void OnModelCreating(ModelBuilder modelBuilder)
            {
                  ...
                  modelBuilder.Entity<WithdrawalRequest>(entity =>
                  {
                        ...
                        entity.Property(w => w.PaymentProofUrl).HasMaxLength(512);
                  });
                  ...
                  modelBuilder.Entity<Payment>(entity =>
                  {
                        ...
                        entity.Property(p => p.Notes).HasMaxLength(512);
                        entity.Property(p => p.ProofImageUrl).HasMaxLength(512);
                        ...
                        entity.HasOne(p => p.WithdrawalRequest)
                            .WithOne(w => w.Payment)
                            .HasForeignKey<Payment>(p => p.WithdrawalRequestId)
                            .OnDelete(DeleteBehavior.Cascade);
                        ...
                        entity.HasOne(p => p.PaidToUser)
                            .WithMany()
                            .HasForeignKey(p => p.PaidToUserId)
                            .OnDelete(DeleteBehavior.Restrict);
                  });

                  modelBuilder.Entity<KhaltiPayment>(entity =>
                  {
                        entity.ToTable("KhaltiPayments");
                        entity.HasKey(x => x.Id);

                        entity.Property(x => x.Pidx).IsRequired().HasMaxLength(100);
                        entity.Property(x => x.PurchaseOrderId).IsRequired().HasMaxLength(100);
                        entity.Property(x => x.Status).IsRequired().HasMaxLength(32);
                        entity.Property(x => x.PaymentUrl).HasMaxLength(512);
                        ...
                        entity.HasIndex(x => x.Pidx).IsUnique();
                  });
